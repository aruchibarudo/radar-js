...
describe('Radar', function () {
  ...
  it('sets the first quadrant', function () {
    ...
    blip = new Blip({ name: 'A', ring: new Ring('First') })
  ...
  describe('blip numbers', function () {
    ...
    beforeEach(function () {
      ...
      firstQuadrant.add([
        new Blip({ name: 'A', ring: firstRing }),
        new Blip({ name: 'B', ring: firstRing })
      ])
      secondQuadrant.add([
        new Blip({ name: 'C', ring: firstRing }),
        new Blip({ name: 'D', ring: firstRing })
      ])
      radar = new Radar()
    })
  ...
  describe('rings : new UI', function () {
    ...
    it('returns an array of rings in configured order and ignore the order in which blips are provided', function () {
      quadrant.add([
        new Blip({ name: 'A', ring: firstRing }),
        new Blip({ name: 'B', ring: secondRing }),
        new Blip({ name: 'C', ring: thirdRing }),
        new Blip({ name: 'D', ring: fourthRing }),
      ])
    ...
    it('should not return invalid rings other than the configured ones', function () {
      quadrant.add([
        new Blip({ name: 'A', ring: firstRing }),
        new Blip({ name: 'E', ring: invalidRing })
      ])
