...
describe('Blip', function () {
  ...
  beforeEach(function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring') })
  })
  ...
  it('has a topic', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: true, status: null, topic: 'topic', description: 'description' })
  ...
  it('is not new', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: false, status: null, topic: 'My topic', description: 'My description' })

    expect(blip.isNew()).toBe(false)
  })

  it('status is new', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: null, status: 'new', topic: 'My topic', description: 'My description' })

    expect(blip.isNew()).toBe(true)
  })

  it('status has moved in', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: null, status: 'Moved In', topic: 'My topic', description: 'My description' })

    expect(blip.hasMovedIn()).toBe(true)
  })

  it('status has moved out', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: null, status: 'Moved Out', topic: 'My topic', description: 'My description' })

    expect(blip.hasMovedOut()).toBe(true)
  })

  it('status has no change', function () {
    blip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: null, status: 'No Change', topic: 'My topic', description: 'My description' })
  ...
  it('get respective group blip width', function () {
    const existingBlip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: false })
    const newBlip = new Blip({ name: 'My Blip', ring: new Ring('My Ring'), isNew: true })
